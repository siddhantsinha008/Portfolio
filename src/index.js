...
import MusicMaster from './assets/Projects/Music-Master'
...
ReactDOM.render(
            ...
            <Switch>
            {/* <Route exact path='/' render={()=><Headers Component={App}/>}/>
            <Route path='/jokes' render={()=><Headers Component={Jokes}/>}/> */}
            <Route exact path='/' render={()=><Headers><App /></Headers>}/>
            <Route path='/jokes' render={()=><Headers><Jokes /></Headers>}/>
            <Route path='/music-master' render={()=><Headers><MusicMaster /></Headers> } />
            </Switch>
            </Router>
